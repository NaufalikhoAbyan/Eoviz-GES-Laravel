...
class SupervisorController extends Controller
{
    ...
    public function update(Request $request, Supervisor $supervisor)
    {
        $supervisor->update($request->validate([
            ...
            'city' => ['required'],
            'postal_code' => ['required', 'integer'],
            'phone' => ['required', 'integer', 'max_digits:12', Rule::unique('supervisors')->ignore($supervisor->phone, 'phone')],
            'mobile' => ['required', 'integer', 'max_digits:12', Rule::unique('supervisors')->ignore($supervisor->mobile, 'mobile')],
