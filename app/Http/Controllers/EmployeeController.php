...
class EmployeeController extends Controller
{
    ...
    public function update(Request $request, Employee $employee)
    {
        $employee->update($request->validate([
            'fullname' => ['required'],
            'personal_id' => ['required'],
            'presence_number' => ['required', 'integer', Rule::unique('employees')->ignore($employee->presence_number, 'presence_number')],
            'place_of_birth' => ['required'],
            'date_of_birth' => ['required'],
            'gender' => ['required'],
            'blood_type_id' => ['required'],
        ...
        return redirect(route('employees.index'))->with(['message' => 'Data successfully changed!']);
    }
    ...
    {
        $employee->delete();
        return redirect(route('employees.index'))->with(['message' => 'Data successfully deleted!']);
    }
}
