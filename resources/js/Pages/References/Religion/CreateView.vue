...
<template>
    <FormCard save-route="reiligions.store" :form="form" method="POST">
        ...
        <TextAreaInputForm title="Description" name="description" :error-message="props.errors.description" v-model="form.name"/>
