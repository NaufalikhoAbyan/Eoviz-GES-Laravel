...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('employees', function (Blueprint $table) {
            ...
            $table->dateTime('effective_functional_pos_start_date');
            $table->dateTime('effective_functional_pos_end_date');
            $table->foreignIdFor(GradeType::class)->constrained()->restrictOnDelete();
            $table->dateTime('effective_grade_start_date');
            $table->dateTime('effective_grade_end_date');
            ...
            $table->dateTime('effective_marital_start_date');
            $table->dateTime('effective_marital_end_date');
            ...
            $table->dateTime('effective_group_shift_start_date');
            $table->dateTime('effective_group_shift_end_date');
            $table->foreignIdFor(Supervisor::class)->constrained()->restrictOnDelete();
            $table->dateTime('effective_supervisor_start_date');
            $table->dateTime('effective_supervisor_end_date');
            $table->timestamps();
        });
    }
